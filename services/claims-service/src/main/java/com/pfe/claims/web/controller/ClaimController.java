package com.pfe.claims.web.controller;
...
public class ClaimController {
    ...
    @PostMapping
    public ResponseEntity<ClaimDto> createClaim(@RequestBody CreateClaimRequest request) {
    ...
    public ResponseEntity<ClaimDto> updateClaim(
            ...
            @RequestBody UpdateClaimRequest request) {
